<template>
  <q-layout view="hHh lpR fFf" class="bg-grey-1">
    ...
    >
      ...
      <q-chip icon="help" to="/help">Help</q-chip>
      <q-chip icon="alarm" label="Set alarm" />
      <q-item to="/help"><q-chip class="glossy" icon="directions">Get directions</q-chip></q-item>
      <q-btn to="/help" label="To Docs index" outline color="purple" />
    </div>
        </q-list>
      </q-scroll-area>
    </q-drawer>
